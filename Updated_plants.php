					 ...
					 <div class="col-lg-7 col-md-7">
						...
						<div class="card-footer">
							<div class="row" style="padding:10px 0;">
							 ...
							 <div class="col-lg-4 col-md-4"><a href="<?php echo "edit_plant.php?id=$id"; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a></div>
							 <div class="col-lg-4 col-md-4"><a href="<?php echo "delete_plant.php?plant_id=$id"; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></div>
							</div>
						</div>
					</div>
				</div>
